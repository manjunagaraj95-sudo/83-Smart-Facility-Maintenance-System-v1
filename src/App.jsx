  ...
  return (
    <div className="dashboard-container">
      <div className="dashboard-grid" style={{ marginBottom: 'var(--spacing-lg)' }}>
        ...
        <MetricCard title="Revenue Growth" value="+12.5%" label="Vs Last Quarter" colorClass="text-success" />
      </div>
...
const Reports = () => (
  <div className="reports-page dashboard-container">
    ...
    <div className="card" style={{marginTop: 'var(--spacing-md)'}}>
        ...
        <p>Revenue: <span className="text-success font-bold">$1,500,000</span></p>
        <p>Expenses: <span className="text-danger font-bold">$750,000</span></p>
        <p>Profit: <span className="text-success font-bold">$750,000</span></p>
    </div>
  </div>
);
